...
var defaultParams = {
  ...
  prefixClasses: ['custom-select-prefix'],
...
function builder(el, builderParams) {
  ...
  function setSelectedElement(cstOption) {
    ...
    if (typeof cstOption !== 'undefined') {
      ...
      openerContent.textContent = selectedElement.customSelectOriginalOption.text;
    } else {
      selectedElement = undefined;
      openerContent.textContent = '';
    }
  ...
  if (builderParams.prefix(select)) {
    var _openerPrefix$classLi;

    var openerPrefix = document.createElement('span');

    (_openerPrefix$classLi = openerPrefix.classList).add.apply(_openerPrefix$classLi, _toConsumableArray(builderParams.prefixClasses));

    openerPrefix.textContent = builderParams.prefix(select);
    opener.appendChild(openerPrefix);
  }

  openerContent = document.createElement('span');
  openerContent.innerHTML = ' ' + (select.selectedIndex !== -1 ? select.options[select.selectedIndex].text : '') + ' ';
  opener.appendChild(openerContent); // Creates the panel
...
/*!*************************!*\
  ...
  \*************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _load_file__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./load-file */ "./src/js/load-file.js");
/* harmony import */ var _show_pass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./show-pass */ "./src/js/show-pass.js");
...
/* harmony import */ var _custom_select__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./custom-select */ "./src/js/custom-select.js");
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! swiper */ "./node_modules/swiper/swiper.esm.js");
/* harmony import */ var _ui_tab__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ui--tab */ "./src/js/ui--tab.js");
/* harmony import */ var _range_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./range-slider */ "./src/js/range-slider.js");
/* harmony import */ var _ui_toggle__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ui--toggle */ "./src/js/ui--toggle.js");
/* harmony import */ var _shopify_draggable__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @shopify/draggable */ "./node_modules/@shopify/draggable/lib/draggable.bundle.js");
/* harmony import */ var _shopify_draggable__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_shopify_draggable__WEBPACK_IMPORTED_MODULE_8__);
...
window.draggable = {
  Sortable: _shopify_draggable__WEBPACK_IMPORTED_MODULE_8__.Sortable,
  Plugins: _shopify_draggable__WEBPACK_IMPORTED_MODULE_8__.Plugins
};
swiper__WEBPACK_IMPORTED_MODULE_4__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_4__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_4__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_4__.Scrollbar, swiper__WEBPACK_IMPORTED_MODULE_4__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_4__.Grid, swiper__WEBPACK_IMPORTED_MODULE_4__.Thumbs, swiper__WEBPACK_IMPORTED_MODULE_4__.EffectFade]);
...
window.addEventListener('DOMContentLoaded', function () {
  _custom_select__WEBPACK_IMPORTED_MODULE_3__["default"].init();
